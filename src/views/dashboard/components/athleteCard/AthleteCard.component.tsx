...
import { UserOutlined, RiseOutlined, CalendarOutlined, CheckCircleOutlined, StopOutlined, StarFilled } from '@ant-design/icons';
 ...
 */
export default function AthleteCard({ athlete, variant = 'default', onClick, rightSlot, className }: AthleteCardV2Props) {
  ...
  return (
    ...
    >
      ...
      <div className={styles.rowTop}>
        <Avatar src={athlete?.profileImageUrl || undefined} icon={<UserOutlined />} size={variant === 'compact' ? 36 : 48} className={styles.avatar} />
            ...
            {variant === 'default' && (
              <div className={styles.chips}>
                {typeof athlete?.isActive === 'boolean' && (
                  <Tag className={styles.chip} color={athlete.isActive ? 'green' : 'red'} icon={athlete.isActive ? <CheckCircleOutlined /> : <StopOutlined />}>
