...
const AchForm = () => {
  ...
  const {} = useInterfaceStore((state) => state);
  ...
  return (
    <Form form={form} className={styles.form} layout="vertical" onFinish={onFinish}>
      <div className={styles.group}>
        ...
        >
          <Input placeholder={'Full name of the account holder'} className={styles.input} />
        </Form.Item>
        <Form.Item
          name="checkaccount"
      ...
      <div className={styles.group}>
        <Form.Item name="billingEmail" label="Billing Email" rules={[{ required: true, message: 'Please input billing email' }]}>
      ...
      <Form.Item name="address" label="Billing Address" rules={[{ required: true, message: 'Please input billing address' }]}>
      ...
      <div className={styles.group}>
        <Form.Item name="country" label="Country" rules={[{ required: true, message: 'Please input your billing country' }]} initialValue={countries[0]}>
        ...
        <Form.Item name="state" label="State" rules={[{ required: true, message: 'Please input your billing state' }]} initialValue={states[0].abbreviation}>
          <select className={styles.input}>
            {states.map((state) => (
      ...
      <div className={styles.group}>
        <Form.Item name="zip" label="Zip" rules={[{ required: true, message: 'Please input customer zip code' }]}>
          <Input placeholder={'Zip Code'} className={styles.input} />
        </Form.Item>
        <Form.Item name="city" label="City" rules={[{ required: true, message: 'Please input customer city' }]}>
